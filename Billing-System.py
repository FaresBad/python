...
class Bill_App:
    def __init__(self,root):
        ...
        item3=Label(snacks,text="Lays(10NIS)",font=("Arial Black",11),bg="#E5B4F3",fg="#6C3483").grid(row=2,column=0,pady=11)
        item3_entry=Entry(snacks,borderwidth=2,width=15,textvariable=self.lays).grid(row=2,column=1,padx=10)

        item4=Label(snacks,text="Oreo(20NIS)",font=("Arial Black",11),bg="#E5B4F3",fg="#6C3483").grid(row=3,column=0,pady=11)
        ...
        item6=Label(snacks,text="Dairy Milk Silk(60NIS)",font=("Arial Black",11),bg="#E5B4F3",fg="#6C3483").grid(row=5,column=0,pady=11)
        item6_entry=Entry(snacks,borderwidth=2,width=15,textvariable=self.silk).grid(row=5,column=1,padx=10)

        item7=Label(snacks,text="Namkeen(15NIS)",font=("Arial Black",11),bg="#E5B4F3",fg="#6C3483").grid(row=6,column=0,pady=11)
...
def total(self):
    ...
    total_snacks_price=(
                ...
                self.si+
                self.na)          
    self.total_sna.set(str(total_snacks_price)+" NIS")
    self.a.set(str(round(total_snacks_price*0.05,3))+" NIS")
    ...
    self.total_gro.set(str(total_grocery_price)+" NIS")
    self.b.set(str(round(total_grocery_price*0.01,3))+" NIS")
    ...
    self.total_hyg.set(str(total_hygine_price)+" NIS")
    self.c.set(str(round(total_hygine_price*0.10,3))+" NIS")
    ...
    self.total_all_bil=str(self.total_all_bill)+" NIS"
    billarea(self)
def intro(self):
    self.txtarea.delete(1.0,END)
    self.txtarea.insert(END,"\tWELCOME TO SUPER MARKET FARES BADRAN\n\tPhone-No.0542808728")
